...
export class AuthService {
  ...
  async checkAccountRegistered(email: string): Promise<boolean> {
    ...
    try {
      ...
      console.warn('[MobileAuthService] Firestore registration check note:', err);
    }
  ...
  async sendResetEmail(email: string) {
    ...
    console.log('[Mobile AuthService] Dispatching password reset email for registered account:', normalizedEmail);
